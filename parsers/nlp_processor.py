...
def process_restaurant_reviews_nlp(
...
def main():
    ...
    parser.add_argument(
        "--force", action="store_true", help="Переобработать все отзывы"
    )
    ...
    if args.stats:
        ...
        process_all_reviews_nlp(force_reprocess=args.force, batch_size=args.batch_size)
